...
{
    public class CircleSweepOld : DelaunayBase
    {
        ...
        public CircleSweepOld(Vector2f[] _points)
            : base(_points)
        {
        ...
        private void Finalize()
        {
            ...
            while (fScan.VertIdx != fStart.VertIdx)
            {
                ...
                while (vecL.AngleCW(vecR) < (Math.PI - float.Epsilon))
                {
        ...
        {
            protected readonly CircleSweepOld CS;

            protected DCircleSweepObj(CircleSweepOld _cs)
                : base(_cs)
            {
                CS = _cs;
            }
        ...
        public class Frontier : DCircleSweepObj //TODO PRIVATE?
        {
            ...
            public Frontier(Triangle _firstTri, CircleSweepOld _cs)
                : base(_cs)
            {
            ...
            public class FrontierPt : DCircleSweepObj
            {
                ...
                public FrontierPt(int vertIdx, HalfEdge _edgeRight, CircleSweepOld _cs)
                    : base(_cs)
                {
                    VertIdx = vertIdx;
        ...
        private class PolartPt : DCircleSweepObj
        {
            ...
            public PolartPt(float _radius, float _theta, CircleSweepOld _cs)
                : base(_cs)
            {
                r = _radius;
                Theta = _theta;
            ...
            public PolartPt(Vector2f _cPt, Vector2f _origin, CircleSweepOld _cs)
                : base(_cs)
            {
                ...
                Theta = CircleSweepOld.AngleFromOrigin(_origin, _cPt);
            }
        }
